...
| `pi-blitz` | Pre-alpha / local CLI review-passed | AST-aware fast edits via `blitz` (Zig 0.16 native binary) | Safe for controlled local wiring; no public savings claim until 10-case benchmark + prebuilts |
